...
SYSTEM_PROMPT = """focus on the main fruit and vegetable just ell how many fruits or vegetable and which 
fruit or vegetable. just answer in 2-3 words. basically act like you are a trained ml model which is
 fine tuned on fruit data so no unnecessary detail and anser in 2-3 words and in response there should
   only be the name of the specific fruit or vegetable only no ther background details"""
    ...
    try:
        ...
        if image:
            try:
                ...
                enhanced_user_message = f"{SYSTEM_PROMPT}\n\nPlease provide a detailed description of this image, focusing on key elements, colors, composition, and any notable features."
